...
class Calc {
    ...
    public static String parse(String expression) throws Exception {
        ...
        if (oper == null) throw new Exception("Ошибочная математическая операция");
        ...
        //если ввели число больше 10
        if (num1 > 10 || num2 > 10) {
            throw new Exception("Числа должны быть от 1 до 10");
        }
        int arabian = calc(num1, num2, oper);
        if (isRoman) {
            //если римское число получилось меньше либо равно нулю, отображаем ошибку
            if (arabian <= 0) {
